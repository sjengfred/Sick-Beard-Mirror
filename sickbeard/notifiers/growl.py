...
class GrowlNotifier:
    ...
    def _send_growl(self, options,message=None):
        ...
        if options['icon']:
            notice.add_header('Notification-Icon', 'https://raw.github.com/xbianonpi/Sick-Beard/master/data/images/sickbeard.png')
    ...
    def _sendRegistration(self, host=None, password=None, name='Sick Beard Notification'):
        ...
        register.add_header('Application-Icon', 'https://raw.github.com/xbianonpi/Sick-Beard/master/data/images/sickbeard.png')
